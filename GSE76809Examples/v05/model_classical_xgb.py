"""
Classical XGBoost baseline (v05): Strong gradient boosting classifier.

Same configuration as v04, applied to the v05 data slice (no SMOTE; XGBoost
handles imbalance through scale_pos_weight).
"""
...
def train_classical_xgb(fold_data=None):
    ...
    print(f"{'='*60}")
    print(f"CLASSICAL XGBoost v05 (Gradient Boosting)")
    ...
    return {
        ...
        "n_params": int(model.n_estimators * (2 ** model.max_depth)),
